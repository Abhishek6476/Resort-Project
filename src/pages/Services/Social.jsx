      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 md:px-10 text-center">
          ...
          <p className="text-gray-700 leading-relaxed text-justify max-w-full mx-auto">
             Ring Ceremonies to lively Cocktail & Mehndi nights and grand Wedding receptions, we plan and execute every detail with care. Celebrate your love story with unforgettable moments in style.
