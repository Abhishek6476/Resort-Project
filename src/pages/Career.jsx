...
//       img: "https://plus.unsplash.com/premium_photo-1667520405114-47d3677f966e?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8aG91c2VrZWVwaW5nJTIwc3RhZmZ8ZW58MHx8MHx8fDA%3D",
//     },
//     {
...
//   // 🔹 Scroll to form when Apply button clicked
//   const handleApplyNow = (jobTitle) => {
//     setFormData((prev) => ({ ...prev, position: jobTitle })); // pre-fill position
...
//                   className="mt-4 bg-blue-800 hover:bg-yellow-600 text-white font-semibold px-4 py-2 rounded-md transition"
//                 >
//                   Apply Now
//                 </button>
//               </div>
...
//       setStatus(
//         data.msg ||
//           (res.ok ? "Application submit Successfully!" : "Submission failed")
//       );
//       if (res.ok) {
//         setFormData({
//           name: "",
...
//       {/* Header Section */}
//       <div className="relative w-full h-[60vh]">
//         <img src={resume} alt="Career Banner" className="w-full h-full object-cover" />
//         <div className="absolute inset-0 bg-gradient-to-r from-black/40 to-black/20 flex items-center justify-center px-8">
//           <div className="text-white max-w-2xl text-center">
//             <h1 className="text-5xl font-bold mb-3">Career Opportunities</h1>
//             <p className="text-lg text-gray-200">
...
//         <p className="text-gray-700 text-justify max-w-full mx-auto text-[16px] leading-[28px]">
//           We believe in teamwork, creativity, and hospitality excellence. Whether it’s a grand wedding, a corporate meeting, or a private event, our staff plays a key role in delivering memorable experiences. At our resort, every team member contributes to a welcoming environment that exceeds guest expectations. We invest in training and professional development to help you grow in your career. Joining our team means becoming part of a community that values respect, integrity, and innovation. We encourage diversity and inclusion to create a workplace where everyone can thrive.
//         </p>
//       </section>

//       {/* Job Listings */}
//       <section className="py-12 px-6 max-w-6xl mx-auto">
//         <h2 className="text-3xl font-bold text-center text-gray-800 mb-10">Current Openings</h2>
//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
//           {jobs.map((job) => (
//             <div key={job._id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
//               <img
//                 src={job.image ? `http://localhost:5000/uploads/${job.image}` : resume}
//                 alt={job.title}
//                 className="h-52 w-full object-cover"
//               />
//               <div className="p-6">
...
//         <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
//           {[
//             { title: "Growth Opportunities", desc: "Enhance your skills and build a rewarding career in the hospitality industry." },
//             { title: "Inclusive Culture", desc: "We celebrate diversity and foster a welcoming workplace for everyone." },
//             { title: "Exciting Events", desc: "Work on weddings, parties, and corporate functions that make lasting memories." }
//           ].map((item, idx) => (
//             <div key={idx} className="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition">
...
//       {/* Application Form */}
//       <section ref={formRef} className="py-16 px-6 md:px-20 bg-white">
//         <h2 className="text-3xl font-bold mb-8 text-center text-gray-900">Job Application</h2>
//         <p className="text-center text-gray-600 mt-2 mb-8">Fill out the form below to start your career journey with us.</p>
//         <form onSubmit={handleSubmit} className="max-w-2xl mx-auto bg-gray-50 p-8 rounded-2xl shadow-md space-y-6">
//           {["name", "email", "phone"].map((field, idx) => (
//             <div key={idx}>
//               <label className="block text-gray-700 font-medium mb-2">{field === "name" ? "Full Name" : field.charAt(0).toUpperCase() + field.slice(1)}</label>
//               <input
...
//           <button type="submit" disabled={isSending} className="w-full bg-blue-800 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-lg transition disabled:opacity-50">
//             {isSending ? "Sending..." : "Submit Application"}
//           </button>

//           {status && (
//             <p className={`text-sm mt-3 font-medium ${status.toLowerCase().includes("success") ? "text-blue-800" : "text-red-600"}`}>
//               {status}
//             </p>
//           )}
//         </form>
...
//       {/* Application CTA */}
//       <section className="relative py-16 px-8 text-center bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${carrier})` }}>
//         <div className="absolute inset-0 bg-black/40"></div>
//         <div className="relative z-10">
//           <h3 className="text-2xl font-semibold text-white mb-4">Didn’t find your role?</h3>
//           <p className="text-gray-200 mb-6">We’re always looking for passionate individuals. Send us your resume and we’ll be in touch!</p>
//           <input
//             type="file"
//             ref={fileInputRef}
//             onChange={async (e) => {
...
//               try {
//                 const res = await fetch("http://localhost:5000/api/job-application/upload-resume", { method: "POST", body: formData });
//                 const data = await res.json();
...
//             className="hidden"
//           />
//           <button onClick={() => fileInputRef.current.click()} className="inline-block bg-blue-800 text-white px-6 py-3 rounded hover:bg-blue-700 transition">Send Resume</button>
//         </div>
//       </section>
//     </div>
//   );
